...
const Login = () => {
  ...
  const {axios, setToken} = useAppContent()
  ...
  return (
    <div className='flex item-center justify-center h-screen'>
        <div className='w-full max-w-sm p-6 max-md:m-6 border border-primary/30 shadow-xl shadow-primary/15 rounded-lg h-[500px] mt-6'>
