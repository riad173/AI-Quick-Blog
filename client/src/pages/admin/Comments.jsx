...
const Comments = () => {
  ...
  return (
    <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      ...
      <div className='relative h-4/5 max-w-3xl overflow-x-auto mt-4 bg-white shadow rounded-lg no-scrollbar'>
        <table className='w-full text-sm text-gray-500'>
          ...
          <tbody>
            ...
            }).map((comments, index) => <CommentTableItem key={comments._id} comment={comments} index={index + 1} fetchComments={fetchComments} />)}
          </tbody>
        </table>
      </div>
